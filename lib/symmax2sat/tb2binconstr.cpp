...
void BinaryConstraint::findSupportX() {findSupport(Functor_getCost(*this),x,y,supportX,deltaCostsX);}
void BinaryConstraint::findSupportY() {findSupport(Functor_getCostReverse(*this),y,x,supportY,deltaCostsY);}
void BinaryConstraint::findFullSupportX() {findFullSupport(Functor_getCost(*this),x,y,supportX,deltaCostsX,supportY,deltaCostsY);}
void BinaryConstraint::findFullSupportY() {findFullSupport(Functor_getCostReverse(*this),y,x,supportY,deltaCostsY,supportX,deltaCostsX);}
void BinaryConstraint::projectX() {projection(Functor_getCost(*this),x,y,y->getValue(),deltaCostsX);}
void BinaryConstraint::projectY() {projection(Functor_getCostReverse(*this),y,x,x->getValue(),deltaCostsY);}
bool BinaryConstraint::verifyX() {return verify(Functor_getCost(*this),x,y);}
bool BinaryConstraint::verifyY() {return verify(Functor_getCostReverse(*this),y,x);}
bool BinaryConstraint::projectX(Value value, Cost cost) {return project(x,value,cost,deltaCostsX);}
bool BinaryConstraint::projectY(Value value, Cost cost) {return project(y,value,cost,deltaCostsY);}
void BinaryConstraint::extendX(Value value, Cost cost) {extend(x,value,cost,deltaCostsX);}
void BinaryConstraint::extendY(Value value, Cost cost) {extend(y,value,cost,deltaCostsY);}
